...
public class Sales extends JFrame {// Inheritance
	...
	public Sales() {// Constructor
		...
		CountButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int num1, num2, ans;
				//
				TotalPrice tp = new TotalPayment();//Interface
				//
				try {// Exception handling
					 // Encapsulation
					...
					if(num2%60 != 0) {
						ans = num1 * ((num2/60)+1) * tp.totalPrice();
						textFieldTotalPrice.setText(Integer.toString(ans));
					}else if(num2%60 == 0) {
						ans = num1 * ((num2/60) * tp.totalPrice());
						textFieldTotalPrice.setText(Integer.toString(ans));
					}
