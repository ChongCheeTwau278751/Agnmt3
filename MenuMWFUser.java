...
//	
	...
	private void initialize() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuMWFAdmin.class.getResource("/A_3/icon.png")));
		...
		btnExit.setIcon(new ImageIcon(MenuMWFAdmin.class.getResource("/A_3/e1.png")));
		...
		lblNewLabel_3.setIcon(new ImageIcon(MenuMWFAdmin.class.getResource("/A_3/m2.png")));
