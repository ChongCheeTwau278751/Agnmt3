...
public class MenuTTSUser extends JFrame {
	...
	public MenuTTSUser() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuTTSAdmin.class.getResource("/A_3/icon.png")));
		...
		button.setIcon(new ImageIcon(MenuTTSAdmin.class.getResource("/A_3/e1.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(MenuTTSAdmin.class.getResource("/A_3/m5.jpg")));
